...
| Herbarium — le piante scrivono — **FATTO 2026-07-16** | nota MIDI → parola del solfeggio (`NOTE_WORDS`: do, dodiesis, re… alfabeto deterministico di 12 glifi) → la pianta scrive la pagina in verde foglia (120,240,110) su pi/screen: cursore sinistra→destra con a-capo, note gravi = segni più grandi, velocity = intensità inchiostro, fade 14s, riparte dall'alto dopo 30s di silenzio. Trasporto: **UDP localhost :8791** da gaia-herbarium (nel bosco non c'è broker MQTT — il canale locale funziona sempre) | pi/screen `_herb_place`/`_herb_udp_listener`, pi/herbarium `_dump_reader` |
